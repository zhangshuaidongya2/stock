#!/usr/bin/env python3
"""Analyze Sina flow matrices for stocks with positive main inflow in a window.

Examples:
  python sina_flow/continuous_inflow.py
  python sina_flow/continuous_inflow.py --days 3
  python sina_flow/continuous_inflow.py --days 5 --top 20
  python sina_flow/continuous_inflow.py --days 8 --min 7
"""
...
from flow.analyze_flow_price import (  # noqa: E402
...
SINA_DATA_DIR = PROJECT_DIR / "sina_data"
DEFAULT_FLOW_PATH = SINA_DATA_DIR / "flow.csv"
DEFAULT_PRICE_PATH = SINA_DATA_DIR / "price.csv"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "分析 sina_data/flow.csv 和 sina_data/price.csv，"
