#!/usr/bin/env python3
"""Analyze one stock over the latest daily files under sina_data/today.

Examples:
  python sina_flow/get_stock_info.py --code 603233 --days 3
  python sina_flow/get_stock_info.py --code 大参林 --days 5
  python sina_flow/get_stock_info.py --code 603233
  python sina_flow/get_stock_info.py --code 603233 --output sina_data/dcl.json
"""
...
from flow.analyze_flow_price import read_matrix  # noqa: E402
...
from build_today_flow_matrix import (  # noqa: E402
    TODAY_DATA_DIR,
    display_path,
    list_daily_files,
    read_daily_snapshot,
...
DEFAULT_TURNOVER_PATH = PROJECT_DIR / "sina_data" / "turnover.csv"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "读取 sina_data/today/ 下最近 days 个交易日文件，"
